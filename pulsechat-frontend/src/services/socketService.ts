...
// Define the shape of the callbacks object that the component will provide
...
export const socketService = {
   ...
   */
  connect: (username: string, callbacks: ConnectionCallbacks) => {
    ...
    socket.onmessage = (event) => {
      ...
      switch (data.type) {
        case 'chat_message':
          callbacks.onChatMessage(data.message as Message);
          break;
        case 'user_list':
